...
if __name__ == "__main__":
    ...
    path_dir = './output'
    print("Getting the 'output' folder path: ", path_dir)

    print("Extracting the image.")
    I = Image.open(path_dir + '/segmented/CosegPP_extension/Buckwheat-C-1/Vis_SV_0/2019-07-03_17-37-18.072_141700_otsu.png')
    Iq = np.asarray(I)
    
    print("Extracting the mask.")
    L  = Image.open(path_dir + '/masks/CosegPP_extension/Buckwheat-C-1/Vis_SV_0/2019-07-03_17-37-18.072_141700_otsu.png')
    Lq = np.asarray(L, np.float32) / 255
    prob = Lq[:, :, :2]
    prob[:, :, 0] = 1.0 - prob[:, :, 0]

    print("Computing the binary denseCRF")
    w1    = 10.0  # weight of bilateral term
    alpha = 80    # spatial std
    beta  = 13    # rgb  std
    w2    = 3.0   # weight of spatial term
